...
angular.module('searchblox.custominput',[])
    .directive('custominput', ["$interpolate", 'autocompleteSearch', function ($interpolate, autocompleteSearch) {
    ...
    return {
        ...
        template: '<div class="ngCustomInput col-sm-7 col-md-7 col-md-offset-3">' +
            ...
            '           ng-change="newTagChange()" autofocus>' +
        ...
        link: function (scope, element) {
            ...
            element.find('div.autocomplete').bind('click', function () {
                input[0].focus();
                scope.onsearch();
            });
        }
